            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
                ...
                <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    @foreach ([
                        ...
                        ['title' => '資料の共有が面倒', 'body' => '大きなファイルをメールで送っても開けない、容量オーバーで送れない。', 'icon' => 'file'],
                        ['title' => '引き継ぎで情報が消える', 'body' => '担当が交代するたびに、過去の記録やメンバー名簿が引き継がれない。', 'icon' => 'handoff'],
        ...
        <section id="features" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 space-y-24 lg:space-y-32">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-1 lg:order-2">
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-ink-600 dark:text-paper-100/70">
                        ...
                        配布したい資料はアップロードするだけで、URLひとつで開けるようになります。
                        印刷してそのまま配布することもできます。
                    </p>
                    <ul class="mt-4 space-y-2 text-sm text-ink-600 dark:text-paper-100/70">
                        ...
                        <li class="flex items-start gap-2"><span class="text-leather-500 dark:text-leather-300 mt-0.5">・</span>議題の下に、さらに細かい項目も追加できる</li>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <ul class="mt-4 space-y-2 text-sm text-ink-600 dark:text-paper-100/70">
                        <li class="flex items-start gap-2"><span class="text-leather-500 dark:text-leather-300 mt-0.5">・</span>表示する内容は組織ごとに自由に選べる</li>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-1 lg:order-2">
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-ink-600 dark:text-paper-100/70">
                        ...
                        表計算ソフトの名簿からもまとめて登録できるので、既存のデータからすぐに移行できます。
                    </p>
                    <ul class="mt-4 space-y-2 text-sm text-ink-600 dark:text-paper-100/70">
                        <li class="flex items-start gap-2"><span class="text-leather-500 dark:text-leather-300 mt-0.5">・</span>一覧は表形式・カード形式を切り替え可能</li>
                        <li class="flex items-start gap-2"><span class="text-leather-500 dark:text-leather-300 mt-0.5">・</span>役職を登録しておけば、みんなの肩書きもすぐ分かる</li>
        ...
        <section class="bg-paper-50 dark:bg-ink-900/40 border-y border-paper-200 dark:border-ink-700">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
                ...
                <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    @foreach ([
                        ['title' => 'ほかの組織に情報が漏れる心配がない', 'body' => '組織ごとにデータを完全に分けているので、安心してお使いいただけます。'],
                        ['title' => '案内状づくりに悩まなくていい', 'body' => '会議の情報から、PDF・メール・LINE用の案内文を自動で作ってくれます。'],
                        ['title' => '印刷しても読みやすい', 'body' => '紙の次第そのままのレイアウトで、印刷用ボタンもワンクリック。'],
                        ['title' => '外部の人にも、リンクひとつで共有できる', 'body' => 'ログインしていない人でも、そのリンクから次第を確認できます。'],
                    ] as $reason)
                        <div>
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
                ...
                <ol class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    @foreach ([
                        ...
                        ['title' => 'メンバーを登録', 'body' => '表計算ソフトのデータからまとめて登録できます。'],
