...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            // バックアップ失敗・容量超過等の通知先。専用のBACKUP_NOTIFICATION_EMAILが
            // 未設定なら、特商法表記等で使っている運営者の連絡先メールアドレスを
            // 流用する(config/legal.phpとは異なりconfig()の読み込み順に依存しない
            // よう、env()を直接ネストして参照している)。
            'to' => env('BACKUP_NOTIFICATION_EMAIL', env('LEGAL_CONTACT_EMAIL', 'your@example.com')),
